...
#set permisions on folder so that the jenkins user in the jenkins container can delete these files from the jenkins build workspace
echo "setting permissions on target directory: $TARGET_DIRECTORY"
